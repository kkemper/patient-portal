...
class InsurancesControllerTest < ActionController::TestCase
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post :create, insurance: { coverageDetails: @insurance.coverageDetails, policyID: @insurance.policyID, providerContact: @insurance.providerContact, providerName: @insurance.providerName }
    end
  ...
  test "should update insurance" do
    patch :update, id: @insurance, insurance: { coverageDetails: @insurance.coverageDetails, policyID: @insurance.policyID, providerContact: @insurance.providerContact, providerName: @insurance.providerName }
    assert_redirected_to insurance_path(assigns(:insurance))
  end
