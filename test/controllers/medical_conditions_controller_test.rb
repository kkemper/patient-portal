...
class MedicalConditionsControllerTest < ActionController::TestCase
  ...
  test "should create medical_condition" do
    assert_difference('MedicalCondition.count') do
      post :create, medical_condition: { description: @medical_condition.description, medicalID: @medical_condition.medicalID, name: @medical_condition.name, symptom: @medical_condition.symptom }
    end
  ...
  test "should update medical_condition" do
    patch :update, id: @medical_condition, medical_condition: { description: @medical_condition.description, medicalID: @medical_condition.medicalID, name: @medical_condition.name, symptom: @medical_condition.symptom }
    assert_redirected_to medical_condition_path(assigns(:medical_condition))
  end
