...
class VitalsControllerTest < ActionController::TestCase
  ...
  test "should create vital" do
    assert_difference('Vital.count') do
      post :create, vital: { Units: @vital.Units, dateTime: @vital.dateTime, patientID: @vital.patientID, vitalDetails: @vital.vitalDetails, vitalID: @vital.vitalID, vital_type: @vital.vital_type }
    end
  ...
  test "should update vital" do
    patch :update, id: @vital, vital: { Units: @vital.Units, dateTime: @vital.dateTime, patientID: @vital.patientID, vitalDetails: @vital.vitalDetails, vitalID: @vital.vitalID, vital_type: @vital.vital_type }
    assert_redirected_to vital_path(assigns(:vital))
  end
